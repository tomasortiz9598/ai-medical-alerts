...
from baml_py.baml_py import (  # noqa: F401 # pylint: disable=unused-import
    ClassBuilder, EnumBuilder, EnumValueBuilder, FieldType)
...
class TypeBuilder(type_builder.TypeBuilder):
    ...
    @property
    def AlertType(self) -> "AlertTypeViewer":
        return AlertTypeViewer(self)

    @property
    def MedicalAlert(self) -> "MedicalAlertViewer":
        return MedicalAlertViewer(self)
...
class AlertTypeAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        ...
        self._bldr = _tb.class_("AlertType")
        ...
        self._props = AlertTypeProperties(self._bldr, self._properties)

    def type(self) -> baml_py.FieldType:
        return self._bldr.field()

    @property
    def props(self) -> "AlertTypeProperties":
        return self._props


class AlertTypeViewer(AlertTypeAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
...
class MedicalAlertAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        _tb = tb._tb  # type: ignore (we know how to use this private attribute)
        self._bldr = _tb.class_("MedicalAlert")
        self._properties: typing.Set[str] = set(
            [
                "type",
                "event",
        ...
        self._props = MedicalAlertProperties(self._bldr, self._properties)

    def type(self) -> baml_py.FieldType:
        return self._bldr.field()

    @property
    def props(self) -> "MedicalAlertProperties":
        return self._props


class MedicalAlertViewer(MedicalAlertAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
